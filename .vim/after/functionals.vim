" This is my standard library. It contains useful stuff. Mostly functional
" list operations...
...
" a little sth with side-effects =)
func! GetRandomFloat(lower, upper)
	...
	return a:lower + map_factor * rand

endfunc

func! GetRandomInteger(lower, upper)
	return float2nr(GetRandomFloat(a:lower, a:upper))
endfunc
